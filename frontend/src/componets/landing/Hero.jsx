...
const HeroSection = () => {
  return (
    <main className="relative z-10 flex flex-col items-start justify-center min-h-[calc(100vh-80px)] px-6 sm:px-12 lg:px-20 max-w-6xl mt-8 sm:mt-0">
      ...
      <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-tight mb-6 bg-gradient-to-r from-blue-700 to-blue-900 bg-clip-text text-transparent">
        Your Productivity,
        <br />
        on <span className="bg-gradient-to-r from-cyan-500 to-blue-500 bg-clip-text text-transparent italic">Autopilot</span>
      </h1>

      <p className="text-blue-800 text-base sm:text-lg md:text-xl mb-8 sm:mb-10 max-w-2xl leading-relaxed">
        Focusphere isn't just a list. It's an <strong>AI Agent</strong> that creates tasks,
        manages goals, and chats with you to organize your life. Experience the
